...
import { faSignOutAlt, faShoppingCart, faLock, faCommentAlt, faPlus, faUserPlus, faAlignJustify } from '@fortawesome/free-solid-svg-icons';
    ...
    return (
        <div className="sidebar d-flex flex-column justify-content-between col-md-2 py-5 px-4" style={{height:"100vh"}}>
            <ul className="list-unstyled">
                <li>
                    <Link to="/" className="text-white fs-2">FixUrPhoto</Link>
                </li>
                <li>
